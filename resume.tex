...
\begin{document}
    ...
    % Senior software engineer with passion for distributed systems.
    ...
    \begin{rSection}{Skills}
        ...
        \begin{rSubsection}{}{}{}{}
            % \item
            %     Compilers (front-end mostly, with LLVM/Clang).
            \item
                Distributed, scalable high-load systems,
                data storage and processing. %, both cloud (AWS) and self-hosted.
            \item
